...
---
### Contents
[1. 앵커 (Anchor)](#앵커-(Anchor))<br>
[^ (캐럿, caret)](#^-(캐럿,-caret))<br>
[$ (달러,  dollar)](#$-(달러,-dollar))<br>
[앵커를 이용해서 완전일치 검사하기](#앵커를-이용해서-완전일치-검사하기)<br>

[2. 메타 문자  (Metacharacters)](#메타-문자-(Metacharacters))
	- [. (점, dot)](#.-(점,-dot))<br>
	- [| (세로선,  pipe)](|-(세로선,-pipe))<br>
	- [ \ (역슬래시, backslash)](#\-(역슬래시,-backslash))<br>

[3. 괄호 및 수량사](#괄호-및-수량사)<br>
[4.요약 문자 (Shorthand Character Classes)](#요약-문자-(Shorthand-Character-Classes))<br>
...
---
### 요약 문자 (Shorthand Character Classes)
