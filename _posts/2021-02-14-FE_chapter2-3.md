...
<img src="https://user-images.githubusercontent.com/53929665/107859004-43f30e80-6e7a-11eb-8c2d-48ccc5360789.jpg" width="450" height="400">
...
여담으로, 글쓴이의 경험상 로그 변환을 적용했음에도 불구하고 정규분포로 변환되지 않는 데이터 분포는 다른 제곱근 변환, 루트 변환, 1/y 변환등 다른 변환으로도 정규분포로 변하지 않을 때가 있다. 이럴 경우는 마지막 정밀 수단인 Box-Cox변환을 이용하고, 이 또한 통하지 않았을 때는 `정규성 가정이 없는 비모수 검정`을 진행해야 한다고 한다.
