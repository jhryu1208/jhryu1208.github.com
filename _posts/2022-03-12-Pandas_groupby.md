...
### <span style="color:navy">1개 열을 기준으로 그룹화<span>
...
### <span style="color:navy">여러 열을 기준으로 그룹화<span>
...
### <span style="color:navy">그룹 연산 메소드<span>
...
### <span style="color:navy">by에 function/dict(혹은 Series)가 전달되는 경우<span>
...
### <span style="color:navy">as_index<span>
