...
### <span style="color:navy">메소드<span>
...
### <span style="color:navy">value_counts 메소드<span>
...
### <span style="color:navy">isnull, notnull 메소드<span>
...
proc_df['notnull()'] = default_df['notnull()'].notnull()
...
### <span style="color:navy">제거 : dropna<span>

`dropna`메소드를 이용해서 데이터프레임의 <u>누락값을 제거</u>할 수 있다. 
<br>`dropna`의 기본형식 및 옵션은 다음과 같다.
